...
from marketingai.views import CompanyMarketSegmentListAPIView, create_company_user, create_new_marketing_segment, create_user_view, get_detailed_description, search, search_results_view, segment_view, send_message, get_mails, create_home_view
